// -------------------------------------------------------------
// 
// File Name: /MATLAB Drive/codegen/fm_filter/hdlsrc/FilterTapSystolicPreAddWvlIn.v
...
// Source Path: fm_filter/dsphdl.FIRFilter/Filter/subFilter/FilterTapSystolicPreAddWvlIn
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module FilterTapSystolicPreAddWvlIn
  ...
  input   signed [47:0] addin;  // sfix48_En45
  input   dinRegVld;
  input   syncReset;
  output  signed [15:0] dinDly2;  // sfix16_En15
  output  signed [47:0] tapout;  // sfix48_En45


  reg signed [49:0] fTap_mult_reg;  // sfix50
  ...
  reg signed [32:0] fTap_coef_reg1;  // sfix33
  reg signed [32:0] fTap_coef_reg2;  // sfix33
  reg signed [49:0] fTap_mult_reg_next;  // sfix50_En45
  ...
  reg signed [47:0] fTap_addout_reg_next;  // sfix48_En45
  reg signed [32:0] fTap_coef_reg1_next;  // sfix33_En30
  reg signed [32:0] fTap_coef_reg2_next;  // sfix33_En30
  reg signed [15:0] dinDly2_1;  // sfix16_En15
  reg signed [47:0] tapout_1;  // sfix48_En45
  reg signed [47:0] fTap_add_cast;  // sfix48_En45
  ...
  initial begin
    ...
    fTap_coef_reg1 = 33'sh000000000;
    fTap_coef_reg2 = 33'sh000000000;
    fTap_mult_reg = 50'sh0000000000000;
  ...
  always @(addin, coefIn_0, dinPreAdd, dinReg2_0_re, dinRegVld, fTap_addout_reg,
    ...
    if (dinRegVld) begin
      fTap_add_cast = fTap_mult_reg[47:0];
